                ...
                <div class="col-md-12">
                    ...
                    <form method="POST" class="form-horizontal form-submit" enctype="multipart/form-data" id="form-submit" action="{{ $url }}">
                        ...
                        <table class="table-input table table-bordered table-hover" border="1">
                            ...
                            <tr class="has-group">
                                <td>Height (ft):</td>
                                <td><input type="text" value="{{ $height }}" name="height" class="lname form-control" required /> </td>
                            </tr>
                            <tr class="has-group">
                                <td>Weight (lbs) :</td>
                                <td><input type="text" value="{{ $weight }}" name="weight" class="lname form-control" required /> </td>
                            </tr>
                            <tr class="has-group">
                                <td>Section :</td>
                                <td><input type="text" value="{{ $section}}" name="section" class="lname form-control" required /> </td>
                            </tr>
                            <tr class="has-group">
