    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li><a href="{{ url('/admin') }}"><i class="fa fa-home"></i> Clubhouse</a></li>
                <li><a href="{{ url('admin/players') }}"><i class="fa fa-users"></i> Players</a></li>
                <li><a href="{{ url('admin/games') }}"><i class="fa fa-calendar"></i> Game Schedule</a></li>
                <li><a href="{{ url('admin/stats') }}"><i class="fa fa-line-chart"></i> Stats</a></li>
                <li class="dropdown">
